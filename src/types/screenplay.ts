export type ScreenplayFormatId =
  | 'scene-header-1'        // Scene Number component
  | 'scene-header-2'        // Scene Setting component
  | 'scene-header-location' // Scene Location component (line 2)
  | 'action'
  | 'character'
  | 'parenthetical'
  | 'dialogue'
...
// Interface for any classification engine
